...
/// A class that implements the [AppColors] interface for the light theme variant.
///
/// This class defines all color values used throughout the application when
/// the light theme is active. It provides consistent color definitions for
/// UI elements such as backgrounds, text fields, buttons, and more.
class AppColorsLight implements AppColors {
  @override
  Color get primaryColor => const Color(0xffffffff);
  @override
  Color get primary => const Color(0xFF1E386D);
  @override
